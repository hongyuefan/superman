...
func (m *MACD_Day) TableName() string {
	return "macd_day"
}

func init() {
	orm.RegisterModel(new(MACD_Day))
}

func GetMACD_Day(m *MACD_Day, col ...string) (err error) {
...
func SetMACD_Day(m *MACD_Day) (num int64, err error) {

	o := orm.NewOrm()

	v := MACD_Day{Time: m.Time}
	...
	return AddMACD_Day(m)
}

func AddMACD_Day(m *MACD_Day) (id int64, err error) {
	o := orm.NewOrm()
	id, err = o.Insert(m)
	return
}
